...
<head>
	<style>
		...
		#searchBox input[type=submit]{width: auto;}
		#outer{display: flex;}
		...
		input[type=text] {border: 2px solid #474747;border-radius: 4px;}
		input[type=text], select, textarea {width: 100%;padding: 12px;border: 1px solid #ccc;border-radius: 4px;resize: vertical;}
		label {padding: 12px 12px 12px 0;display: inline-block;}
		input[type=submit] {background-color: #474747;color: whitesmoke;padding: 12px 20px;border: none;border-radius: 4px;cursor: pointer;float: right;}
		input[type=submit]:hover {background-color: gray；}
		.containerForm {border-radius: 5px;background-color: #474747;padding: 20px;}
